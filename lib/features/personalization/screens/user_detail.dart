...
class gbUserDetailScreen extends StatefulWidget {
  final UserModel? userModel;

  const gbUserDetailScreen({
    Key? key,
    this.userModel,
  }) : super(key: key);

  @override
  State<gbUserDetailScreen> createState() => _GbUserDetailScreenState();
}

class _GbUserDetailScreenState extends State<gbUserDetailScreen> {
  ...
  void initState() {
    ...
    // Obtener el modelo de usuario, ya sea de los props o de los argumentos
    final args = Get.arguments;
    final userFromArgs = args != null && args is Map ? args['userModel'] : null;
    _effectiveUser = widget.userModel ?? userFromArgs;

    // Inicializar el branch seleccionado como predeterminado a nivel de sistema
  ...
  void _setSystemDefaultBranch(BranchModel branch) {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: Text('${branch.name} establecida como sucursal predeterminada'),
              ...
              child: Column(
                ...
                children: [
                  ...
                  _buildInfoCard([
                    ...
                    _buildInfoRow(Icons.badge_outlined, 'Nombre de usuario', user.username),
                    _buildInfoRow(Icons.admin_panel_settings_outlined, 'Rol', _getRoleName(user.role)),
                  ]),
                  ...
                  _buildInfoCard([
                    _buildInfoRow(
                        ...
                        'Fecha de creación',
                        user.createdAt != null ? _formatDate(user.createdAt!) : 'No disponible'
                    ),
                    _buildInfoRow(
                        Icons.update_outlined,
                        'Última actualización',
                        user.updatedAt != null ? _formatDate(user.updatedAt!) : 'No disponible'
                    ),
                  ]),
      ...
      children: [
        Row(
          ...
          children: [
            ...
            Tooltip(
              message: 'La selección de sucursal predeterminada solo afecta a esta sesión',
              child: Row(
        ...
        ListView.builder(
          ...
          itemBuilder: (context, index) {
            ...
            final isDbDefault = branch.isDefault == "S" || branch.isDefault == "true";
            ...
            return Card(
              ...
              child: ListTile(
                ...
                trailing: isSystemDefault
                  ...
                  tooltip: 'Establecer como predeterminada del sistema',
                  onPressed: () => _setSystemDefaultBranch(branch),
                )
                    : null,
              ),
            );
