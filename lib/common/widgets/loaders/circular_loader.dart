...
class gbCircularLoader extends StatelessWidget {
  ...
  const gbCircularLoader({
    super.key,
    this.foregroundColor = gbColors.white,
    this.backgroundColor = gbColors.primary,
  });
  ...
  Widget build(BuildContext context) {
    return Container(
      padding: const EdgeInsets.all(gbSizes.lg),
