...
class gbDataTable extends StatelessWidget {
  const gbDataTable({
    super.key,
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      child: DataTable2(
        ...
        headingRowColor: WidgetStateProperty.resolveWith((states) => gbColors.primary),
        // Set the decoration for the data table
        decoration: const BoxDecoration(
          color: Colors.white,
          borderRadius: BorderRadius.all(Radius.circular(gbSizes.borderRadiusMd)),
        ),
        // Set the decoration for the heading row of the data table
        headingRowDecoration: const BoxDecoration(
          borderRadius: BorderRadius.only(topLeft: Radius.circular(gbSizes.borderRadiusMd), topRight: Radius.circular(gbSizes.borderRadiusMd)),
        ),
      ),
    );
  }
