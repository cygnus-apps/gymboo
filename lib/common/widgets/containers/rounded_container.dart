...
class gbRoundedContainer extends StatelessWidget {
  ...
  const gbRoundedContainer({
    ...
    this.padding = const EdgeInsets.all(gbSizes.md),
    this.borderColor = gbColors.borderPrimary,
    this.radius = gbSizes.cardRadiusLg,
    this.backgroundColor = gbColors.white,
    this.onTap,
  });
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: [
            if (showShadow)
              BoxShadow(
                color: gbColors.grey.withOpacity(0.1),
                spreadRadius: 5,
                blurRadius: 8,
