...
class gbRoundedImage extends StatelessWidget {
  ...
  Widget _buildNetworkImage() {
    if (image != null) {
      ...
      return CachedNetworkImage(
        ...
        progressIndicatorBuilder: (context, url, downloadProgress) => gbShimmerEffect(width: width, height: height),
      );
    } else {
