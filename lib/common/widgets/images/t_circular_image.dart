...
import 'package:gymboo_admin/common/widgets/shimmers/shimmer.dart';

class gbCircularImage extends StatelessWidget {
  const gbCircularImage({
    super.key,
    this.width = 56,
    this.height = 56,
    this.overlayColor,
  ...
  Widget _buildNetworkImage() {
    if (image != null) {
      ...
      return CachedNetworkImage(
        ...
        progressIndicatorBuilder: (context, url, downloadProgress) => const gbShimmerEffect(width: 55, height: 55),
      );
    } else {
