...
import 'package:gymboo_admin/common/widgets/icons/t_circular_icon.dart';
...
class gbImageUploader extends StatelessWidget {
  const gbImageUploader({
    super.key,
    this.image,
      ...
      children: [
        ...
        circular
            ? gbCircularImage(
                ...
                backgroundColor: gbColors.primaryBackground,
              )
            : gbRoundedImage(
                image: image,
                width: width,
        ...
        Positioned(
          ...
          right: right,
          bottom: bottom,
          child: gbCircularIcon(
            icon: icon,
            size: gbSizes.md,
            color: Colors.white,
            onPressed: onIconButtonPressed,
            backgroundColor: gbColors.primary.withOpacity(0.9),
          ),
        )
      ],
    );
